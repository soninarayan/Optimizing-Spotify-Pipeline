...
def songs(data):
    ...
    for row in data['items']:
        ...
        song_element={'sond_id':song_id , 'song_name':song_name, 'duration_ms':song_duration, 'url':song_url, 'popularity':song_popularity, 'song_added':song_added, 'album_id': album_id, 'artist_id': artist_id }
